...
def time_and_relative_detrending_in_space(obs, trace_x, trace_y, order,
    ...
    Args:
        ...
        sigmas (lst of float, optional): sigmas to reject outliers at for each
        window supplied. Defaults to [5.0,3.5].
        ...
        windows (int, optional): median time-series of pixels is computed using
        pixels +/- window length away from target pixel. Defaults to [10,5].
