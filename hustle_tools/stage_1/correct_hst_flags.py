...
def correct_hst_flags(obs, flags=[4,16,4096], replace=True,
    ...
    Args:
        ...
        flags (list, optional): FLAG values to correct. See HST WFC3/UVIS
        G280 handbook for details. Defaults to [4,16,4096].
        replace (bool, optional): whether to replace or simply mask the flagged
